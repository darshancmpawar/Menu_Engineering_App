...
Per-client overrides live in `customisation/client rules/<slug>.json`.
...
Stored per client in `customisation/client rules/<slug>.json`, loaded fresh on every request:

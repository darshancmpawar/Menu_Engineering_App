...
CREATE INDEX idx_week_signatures_client_date
    ON week_signatures(client_name, week_start DESC);

-- Prevent saving the exact same week twice
CREATE UNIQUE INDEX idx_week_signatures_unique
